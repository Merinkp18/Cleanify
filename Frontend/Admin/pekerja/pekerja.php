...
<script>
  (function () {
    ...
    const table = input.closest('.pekerja-page')?.querySelector('table');
    ...
    function applyFilter() {
      ...
      rows.forEach(tr => {
        // kalau baris "Data pekerja tidak tersedia", biarin tampil
        if (tr.children.length === 1) return;

        const nameCell = tr.children[1]; // kolom "Nama Pekerja" (index 1)
