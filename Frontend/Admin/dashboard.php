...
// auth_admin.php otomatis menolak cleaner & user
// jadi dashboard ini hanya bisa dilihat ADMIN
...
<body>
    ...
    <!-- SIDEBAR -->
    <div class="sidebar">
        <!-- Hanya ADMIN yang bisa lihat semua menu ini -->
        <?php if ($_SESSION['role'] === 'admin'): ?>
            <a href="dashboard.php?page=home" class="active"><i class="fa fa-home me-2"></i> Dashboard</a>
            <a href="layanan/layanan.php"><i class="fa fa-broom me-2"></i> Layanan</a>
            <a href="order/order.php"><i class="fa fa-shopping-cart me-2"></i> Order</a>
            <a href="jadwal/jadwal.php"><i class="fa fa-calendar me-2"></i> Jadwal</a>
            <a href="customer/customer.php"><i class="fa fa-users me-2"></i> Customer</a>
            <a href="pekerja/pekerja.php"><i class="fa fa-user-tie me-2"></i> Pekerja</a>
        <?php endif; ?>
    </div>
...
if ($page !== 'home') {
    ...
    // Mapping halaman admin ke folder aslinya
    $routes = [
        'layanan'  => 'layanan/layanan.php',
        'customer' => 'customer/customer.php',
        'order'    => 'order/order.php',
        'jadwal'   => 'jadwal/jadwal.php',
        'pekerja'  => 'pekerja/pekerja.php'
    ];
