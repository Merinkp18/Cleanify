...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2025 at 12:18 AM
...
(5, 'Linda', 'linda@gmail.com', '085123456767', 'Jl. Mawar No. 15', 'whatsapp', 'apartment', 38, 'Apartemen Mawar Tower B Lt. 10', '2025-11-19 20:54:45', '2025-12-10 16:46:58');
...
(1, 'EMP-001', 'Wildan Fahmi', 'Regular Cleaner', 'active', 4.60, '081234567890', 'enjel.cleanify@mail.com', NULL, 'emp_4bbaa8498ca70286150ccf7b.jpeg', 'Jl. Melati No. 10, Bandung', 'Julianto', '081200000111', 'Sapu & Pel, Lap Debu, Kaca Kecil', 0, 'Basic Cleaning Certification', '2025-01-20', '08:00:00', '12:00:00', 'morning', 'scheduled', '2024-05-12', '2025-11-19 19:51:56', '2025-12-10 17:33:17'),
(2, 'EMP-002', 'Jibril Judex', 'Deep Clean Specialist', 'active', 4.80, '081298765432', 'redup.cleanify@mail.com', NULL, 'emp_2cd1f849ad6cf16ac9a54ed1.jpeg', 'Jl. Sukajadi No. 50, Bandung', 'Budi Saputra', '081299998888', 'Deep Clean, Vacuum, Kitchen & Bathroom Expert', 0, 'Deep Clean Pro Level 2', '2025-01-20', '13:00:00', '17:00:00', 'afternoon', 'scheduled', '2023-11-02', '2025-11-19 19:51:56', '2025-12-10 17:32:01'),
(3, 'EMP-003', 'Muhammad Rafly', 'Premium Senior Staff', 'on_leave', 4.90, '081277744410', 'amita.cleanify@mail.com', NULL, 'emp_92baaef5c616f909451502ba.jpeg', 'Cirebon', 'Budi', '081311112222', 'Detailing, Aromatherapy Setup, VIP Handling, Eco Cleaning', 2, 'Premium Service Certification', '2025-01-25', '07:00:00', '15:00:00', 'full', 'scheduled', '2022-09-18', '2025-11-19 19:51:56', '2025-12-10 17:30:26'),
(4, NULL, 'Merin Kharista', 'Regular Cleaner', 'active', 5.00, '085703116149', 'merin@gmail.com', NULL, 'emp_70d1ff200d7afdaefac3f5ed.jpeg', 'Jl Telaga Permata 42, Dki Jakarta', 'Putri', '081311113333', 'Menyapu,membersihkan permukaan lantai atau bagian dari bangunan dari debu, sampah, dan sebagainya.', 0, '', NULL, NULL, NULL, 'full', 'scheduled', NULL, '2025-12-05 02:15:33', '2025-12-10 17:27:52'),
(7, NULL, 'Muhammad Devani', 'Regular Cleaner', 'active', 4.00, '085123456789', 'admin1@gmail.com', NULL, 'emp_33618b720151e19624df78ad.jpeg', 'subang', 'budi', '081200000111', 'menyapu', 0, '', NULL, NULL, NULL, 'full', 'scheduled', NULL, '2025-12-09 04:52:52', '2025-12-10 17:25:23'),
(8, NULL, 'Ahmad Refiansyah', 'Regular Cleaner', 'active', 4.00, '081277744410', 'redup7@gmail.com', NULL, 'emp_d6d33501ef9ef38d6bf53341.jpeg', 'bengkulu', 'redup', '081299998888', 'Menyapu, Membersihkan Sofa, Membersihkan Kaca', 0, '', NULL, NULL, NULL, 'full', 'scheduled', NULL, '2025-12-09 06:01:16', '2025-12-10 17:36:35');
...
INSERT INTO `reviews` (`id`, `customer_id`, `rating`, `review`, `created_at`) VALUES
(1, 1, 5, 'Datang tepat waktu, bersihnya detail sampai sudut-sudut. Mantap!', '2025-12-14 23:03:58'),
(2, 2, 5, 'Booking cepat, admin responsif. Rumah langsung rapi dan wangi.', '2025-12-14 23:03:58'),
(3, 3, 4, 'Overall bagus, cuma butuh sedikit lebih teliti di area dapur.', '2025-12-14 23:03:58'),
(4, 4, 5, 'Cleaner sopan dan kerja cepat. Hasilnya bikin puas banget.', '2025-12-14 23:03:58'),
(5, 5, 4, 'Hasil bersih dan rapi. Next coba paket deep cleaning biar makin maksimal.', '2025-12-14 23:03:58');
...
(26, NULL, 'iya', 'redup.cleanify@mail.com', '$2y$10$vErbe2tgK1MHTyC6Scoh7Om7d2xaS039ATEzt99PjVGp1vs.M75Y.', 'user', '2025-12-14 20:00:12', '2025-12-14 20:00:12');
